...
const EditStaff = () => {
  ...
  useEffect(() => {
    ...
    // Fetch staff data
    axios.get(`https://mombasa-backend-1.onrender.com/admin/staff/${id}`)
      .then(res => {
        if (res.data.Status) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(`https://mombasa-backend-1.onrender.com/admin/staff/${id}`, updatedStaff);
      if (res.data.Status) {
